...
<div class="system-message {$codeText}">
    <div class="image">
        <img src="/static/images/{$codeText}.svg" alt="" width="150" />
    </div>
    <h1>{$msg}</h1>
    {if $url}
        <p class="jump">
    ...
    {/if}
    <p class="clearfix">
        <a href="{:url('/admin/')}" class="btn btn-grey">返回首页</a>
        {if $url}
...
<div class="copyright">
    <p>Powered by <a href="https://www.zhangshaoping.com/">张绍平网络工作室</a></p>
</div>
{if $url}
